...
class MeterErrorTest : public MeterCommunication
{
    Q_OBJECT
public:
    explicit MeterErrorTest(float voltage, float current, float tolerance, float testPowerFactor, QString serialPort, QObject *parent = nullptr, QString tag = "");
