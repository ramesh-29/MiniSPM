...
private:
    ...
    QTimer* timeout;
    QTimer* tmrStopPhaseNeutral;

    CALIBRATION calibrateWhat;

    PVState *authenticating;
    PVState *phaseCalibration;
    PVState *tmrPhaseToNeutral;
    PVState *neutralCalibrating;
    PVState *neutralCalibrating1;
    PVState *calibrationTimeout;
    QFinalState *failed;
